...
//        myApple.setPrice(1223.34);
//        Product myWindows = new Windows("Windows vista", false, "something");
//        myWindows.setPrice(123.34);
//        //pre-written code---------------------
...
//    myCart.add(iphone);
//
//      Cashier Bobbie = new Cashier("Bobbie", "Escobedo", 42);
//        System.out.println("Bobbie.total(myCart) = " + Bobbie.total(myCart));
//    }
//}
